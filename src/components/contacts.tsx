				...
				<div className="h-full flex flex-col justify-evenly">
					...
					<div className="flex items-center justify-around mt-5 h-[350px]">
						<div className="flex items-center  gap-2  h-3/5 px-4">
							<LinkedinIcon fill="#0b65c3" width={64} height={64} />
							<Link
								href={"https://www.linkedin.com/in/nathan-yan-alves/"}
								target="_blank"
							>
								<span className="text-3xl">Nathan Yan</span>
							</Link>
						</div>
						<div className="flex items-center gap-2  h-3/5 px-4">
							{theme === "dark" ? (
								<GitHubWhiteIcon width={64} height={64} />
							) : (
								<GitHubBlackIcon width={64} height={64} />
							)}
						...
						<div className="flex items-center  gap-2 h-3/5 px-4">
							<Mail width={64} height={64} />
							<Link href={"mailto:yan_dev@zohomail.com"} target="_blank">
								<span className="text-3xl">Yan Dev</span>
							</Link>
						</div>
					</div>
				</div>
